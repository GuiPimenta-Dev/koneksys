...
exports.deleteManufacturerController = exports.deleteManufacturerUseCase =
  void 0;
...
const deleteManufacturerUseCase =
  new DeleteManufacturerUseCase_1.DeleteManufacturerUseCase(
    postgresManufacturersRepository
  );
exports.deleteManufacturerUseCase = deleteManufacturerUseCase;
const deleteManufacturerController =
  new DeleteManufacturerController_1.DeleteManufacturerController(
