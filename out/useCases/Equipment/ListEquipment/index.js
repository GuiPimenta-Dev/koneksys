...
const listEquipmentUseCase = new ListEquipmentUseCase_1.ListEquipmentUseCase(postgresEquipmentsRepository);
exports.listEquipmentUseCase = listEquipmentUseCase;
const listEquipmentController = new ListEquipmentController_1.ListEquipmentController(listEquipmentUseCase);
