...
exports.updateManufacturerController = exports.updateManufacturerUseCase = void 0;
...
const updateManufacturerUseCase = new UpdateManufacturerUseCase_1.UpdateManufacturerUseCase(postgresManufacturersRepository);
exports.updateManufacturerUseCase = updateManufacturerUseCase;
const updateManufacturerController = new UpdateManufacturerController_1.UpdateManufacturerController(updateManufacturerUseCase);
