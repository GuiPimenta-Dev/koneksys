...
exports.createManufacturerController = exports.createManufacturerUseCase =
  void 0;
...
const createManufacturerUseCase =
  new CreateManufacturerUseCase_1.CreateManufacturerUseCase(
    postgresManufacturersRepository,
    mailtrapMailProvider
  );
exports.createManufacturerUseCase = createManufacturerUseCase;
const createManufacturerController =
  new CreateManufacturerController_1.CreateManufacturerController(
