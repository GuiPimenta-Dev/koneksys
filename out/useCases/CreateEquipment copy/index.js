...
const createEquipmentUseCase = new CreateEquipmentUseCase_1.CreateEquipmentUseCase(postgresEquipmentsRepository);
exports.createEquipmentUseCase = createEquipmentUseCase;
const createEquipmentController = new CreateEquipmentController_1.CreateEquipmentController(createEquipmentUseCase);
