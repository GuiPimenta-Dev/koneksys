...
const listEquipmentsUseCase = new ListEquipmentsUseCase_1.ListEquipmentsUseCase(
  postgresEquipmentsRepository
);
exports.listEquipmentsUseCase = listEquipmentsUseCase;
const listEquipmentsController =
  new ListEquipmentsController_1.ListEquipmentsController(
